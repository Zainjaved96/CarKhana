...
function LoginForm() {
  ...
  <div className=" px-5 py-24 mx-auto bg-white">
    <div className="flex flex-col text-center w-full mb-12">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed  text-muted text-base text-center">Already Have an Account? <Link to="/signup">Singup</Link> here.</p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto ">
      <div className="flex flex-wrap m-2">
        <div className="p-2 w-1/2">
          <div className="relative">
            <label htmlFor="name" className="leading-7 text-sm text-gray-900">Email</label>
        ...
        <p className=' text-sm text-muted' >Already Have a Acccount? <Link to="/singup">Singup</Link></p>
